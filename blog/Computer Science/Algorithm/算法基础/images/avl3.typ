...
#diagram(
  ...
  edge-stroke: 1pt,
  {
    ...
    let (c2, b2, d2, a2, e2) = ((11,1), (10,3),(12,3),(9,5),(13,5))
    ...
    edge((5, 3), (8, 3), "->", text(size: 16pt, [
      LeftRotate(B), RightRotate(D)
    ]))
    ...
    edge(b2, a2)
    edge(d2, e2)
    edge(d2, (d2.at(0) - 0.6, 4.3))
    edge(b2, (b2.at(0) + 0.6, 4.3))
    edge(e2, (e2.at(0) - 0.6, 6.3))
    edge(e2, (e2.at(0) + 0.6, 6.3))
    edge(a2, (a2.at(0) - 0.6, 6.3))
    edge(a2, (a2.at(0) + 0.6, 6.3))
  }
)
