    ...
    \matrix[row sep=1cm, column sep=1cm] {
        ...
        child[real edge] {node[circlenode, fill=red] {S}
                child[real edge] {node[circlenode, fill=black] {C}
                        ...
                        child[real edge] {node[circlenode, fill=black] (tree4){}}
                    }
                child[missing]
                child[real edge] {node[circlenode, fill=black] {D}
                        child[real edge] {node[circlenode, fill=black] (tree5){}}
                        child[real edge] {node[circlenode, fill=black] (tree6){}}
                    }
            };
        ...
        child[real edge] {node[circlenode, fill=black] {D}
                ...
                child[real edge] {node[circlenode, draw=none, fill=black] (tree6){}}
            };
